...
if (isset($_POST["filter_btn"])) {
  ...
  $query = "SELECT * FROM mtechforeign WHERE college_name LIKE '%$filter_value%'";
} else {
  $query = "SELECT * FROM mtechforeign";
}
...
<body>
  <div class="conatiner-xxl pb-4">
    ...
    <div class="image-overlay"><h1> List of top 50 Colleges of M.tech across the World.</h1>
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_location" id="exampleFormControlSelect1">
                    ...
                    <?php
$sql = "SELECT DISTINCT country FROM mtechforeign";
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_rank" id="exampleFormControlSelect1">
                    ...
                    <?php
$sql = "SELECT `qs-rank` FROM mtechforeign";
$result = mysqli_query($con, $sql);
