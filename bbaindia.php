...
if (isset($_POST["filter_btn"])) {
  ...
  $query = "SELECT * FROM bbaindia WHERE college_name LIKE '%$filter_value%'";
} else {
  $query = "SELECT * FROM bbaindia";
}
...
<body>
  <div class="conatiner-xxl pb-4">
    ...
    <div class="image-overlay"><h1> List of top 50 Colleges of BBA across the India.</h1>
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_location" id="exampleFormControlSelect1">
                    ...
                    <?php
$sql = "SELECT DISTINCT state1 FROM bbaindia";
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header bg-dark">
                        <h4 style="color: white;"> Management(BBA)
