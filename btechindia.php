...
if (isset($_POST["filter_btn"])) {
  ...
  $query = "SELECT * FROM btechindia WHERE college_name LIKE '%$filter_value%'";
} else {
  $query = "SELECT * FROM btechindia";
}
...
<body>
  <div class="conatiner-xxl pb-4">
    ...
    <div class="image-overlay"><h1> List of top 50 Colleges of B.tech across the India.</h1>
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_location" id="exampleFormControlSelect1">
                    ...
                    <?php
$sql = "SELECT DISTINCT state1 FROM btechindia";
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_rank" id="exampleFormControlSelect1">
                    <option>NIRF</option>
                    <?php
$sql = "SELECT `nirf` FROM btechindia";
$result = mysqli_query($con, $sql);
...
?>
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header bg-dark">
                        <h4 style="color: white;"> Engineering (B.tech)
                            ...
                            <table class="table table-responsive table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($query_run as $student) { ?>
                                        <tr>
                                            <td><?= $student['id']; ?></td>
                                            <td> <a href="college_detail.php/?college_name=<?= $student['college_name']; ?>"><?= $student['college_name']; ?></a></td>
                                            ...
                                            <td><a href="<?php echo $student['official-link']; ?>">official link</a></td>
                                            <td>
                                            <div class="dropdown">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item"  href="<?php echo $student['fee-link']; ?>" style="color: #023e8a; ">Fee structure</a>
    <a class="dropdown-item" href="<?php echo $student['academic-link']; ?>" style="color: #023e8a; ">Academics details</a>
    <a class="dropdown-item" href="<?php echo $student['exam-link']; ?>" style="color: #023e8a; ">Exam Link</a>
