                ...
                <div class="container py-4 pt-4">
                    <div class="row wow1">
                        <div class="col-lg-4 col-md-4 col-sm-6 pb-4 text-center">
                            ...
                            <p><?php echo  $show['nirf']; ?>(Management Category)</p>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-6 pb-4 text-center">
                            <div class="d-flex align-items-center justify-content-center py-4">
        ...
        <div class="container-xxl py-0  wow3">
            <div class="container">
                ...
                <div class="row px-5 py-2">
                    ...
                    <ul>
                            <li><?php echo  $show['course1a']; ?></li>
                              <li>  <?php echo  $show['course1b']; ?></li>
                        </ul>
                ...
                <div class="row px-5 py-2">
                    <div colspan="2">
                        <h5 class="py-3">MBA</h5>

                    </div>
                    <div class="px-5" colspan="3">
                        
                        <ul>
                            <li><?php echo  $show['course2a']; ?></li>
                              <li>  <?php echo  $show['course2b']; ?></li>
                        </ul>
