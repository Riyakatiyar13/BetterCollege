...
if (isset($_POST["filter_btn"])) {
  ...
  $query = "SELECT * FROM mtechindia WHERE college_name LIKE '%$filter_value%'";
} else {
  $query = "SELECT * FROM mtechindia";
}
...
<body>
  <div class="conatiner-xxl pb-4">
    ...
    <div class="image-overlay"><h1> List of top 50 Colleges of M.tech across the India.</h1>
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_location" id="exampleFormControlSelect1">
                    ...
                    <?php
$sql = "SELECT DISTINCT state1 FROM mtechindia";
        ...
        <div class="col-lg-2 col-md-2 col-sm-4 pt-4">
            <div class="form-group">
                <select class="form-control outline-primary mx-2" name="filter_rank" id="exampleFormControlSelect1">
                    <option>NIRF</option>
                    <?php
$sql = "SELECT `nirf` FROM mtechindia";
$result = mysqli_query($con, $sql);
            ...
            <div class="col-md-12">
                <div class="card mt-4">
                    <div class="card-header bg-dark">
                        <h4 style="color: white;"> Engineering (M.tech)
                                ...
                                <tbody>
                                    <?php foreach ($query_run as $student) { ?>
                                        <tr>
                                            ...
                                            <td><?= $student['city']; ?></td>
                                            <td><?= $student['fees']; ?></td>
                                            <td><?= $student['entrance-exam']; ?></td>
                                            
                                            <td><?= $student['nirf']; ?></td>
                                            <td><?= $student['package']; ?></td>
                                           
                                            <td><a href="<?php echo $student['official-website']; ?>">official link</a></td>
                                            <td>
                                            <div class="dropdown">
